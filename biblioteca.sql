...
(131, 'O Código Da Vinci', 'Gibiei', 'História'),
...
select a.nome as "Nome do Aluno", min(data_emprestimo) as "Primeiro Empréstimo", max(data_emprestimo) "Último Empréstimo"
from alunos a 
join emprestimos e on a.id = e.aluno_id
group by a.nome;
